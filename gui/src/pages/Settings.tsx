                ...
                <Card>
                    <CardHeader className="flex flex-row items-center justify-between space-y-0">
                        <div className="space-y-1">
                            ...
                            <CardDescription>Authentication keys used by downstream clients and LLMWAY to connect to this router.</CardDescription>
                        </div>
                        ...
                        <form onSubmit={handleCreate}>
                            ...
                            <div className="grid gap-4 py-6">
                                <div className="space-y-2">
                                    ...
                                    <Input value={newLabel} onChange={e => setNewLabel(e.target.value)} placeholder="e.g. LLMWAY Production" autoFocus />
                                </div>
                            </div>
                            <DialogFooter>
